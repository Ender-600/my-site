...
const collaborationTypes = [
  {
    ...
    description: "Full-stack web applications, mobile apps, and system architecture",
    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
              ...
              <Card key={index} className="group bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-xl bg-gradient-to-br ${method.color} text-white shadow-lg group-hover:shadow-xl transition-all duration-300`}>
                      {method.icon}
                    </div>
          ...
          {/* Collaboration Types */}
          <div>
            <h3 className="text-2xl font-bold mb-6 text-white">Areas of Collaboration</h3>
              ...
              {collaborationTypes.map((type, index) => (
                <Card key={index} className="group bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                  <CardContent className="p-6 text-center">
                    <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${type.color} text-white shadow-lg group-hover:shadow-xl transition-all duration-300 mb-4`}>
                      {type.icon}
                    </div>
          ...
          <Card className="bg-white/5 backdrop-blur-md border border-white/10">
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Label htmlFor="type" className="text-white mb-2 block">Type of Inquiry</Label>
                  <select
                    id="type"
                    value={formData.type}
        ...
        <Card className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-md border border-white/20">
          <CardContent className="p-12">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Whether you're looking for a technical collaborator, research partner, or just want to discuss 
              the latest in AI and technology, I'd love to hear from you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="bg-white/5 border-white/20 text-white hover:bg-white/10 px-8 py-3 rounded-xl">
